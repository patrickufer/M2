 ...
 */
 public class AntLabMain {
    ...
    public void printOutMessage() {
		...
		Person1 p1 = new Person1("Jack Wolfard");
		toPrint += p1.toString("jwolfard3");

        //Person2 replace P2 with your name
		//and gburdell with your gt id
		Person2 p2 = new Person2("Joseph Meredith");
		toPrint += p2.toString("jmeredith37");

        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Bradley Allnutt");
        toPrint += p3.toString("ballnutt3");

        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Patrick");
        toPrint += p4.toString("pufer3");

        //Person5 replace P4 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Noah Boerner");
        toPrint += p5.toString("nboerner3");
